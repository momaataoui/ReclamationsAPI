...
namespace ReclamationsAPI.Migrations
{
    ...
    [Migration("20250815084320_AddHistoriqueStatutTable")]
    partial class AddHistoriqueStatutTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReclamationsAPI.Models.HistoriqueStatut", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ReclamationsAPI.Models.HistoriqueStatut", b =>
                {
                    b.HasOne("ReclamationsAPI.Models.Statut", "AncienStatut")
                        .WithMany()
                        .HasForeignKey("AncienStatutId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ReclamationsAPI.Models.Statut", "NouveauStatut")
                        .WithMany()
                    ...
                    b.HasOne("ReclamationsAPI.Models.Utilisateur", "ModifiePar")
                        .WithMany()
                        .HasForeignKey("UtilisateurId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
